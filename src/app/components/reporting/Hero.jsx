            ...
            <div className="flex flex-col items-center justify-center min-h-screen" style={{ backgroundImage: "url('/ellipse.png')" }}>
                ...
                <div className="text-center space-y-6 my-10 px-4">
                    ...
                    <p className="my-10 text-start font-extrabold text-5xl md:text-7xl lg:text-8xl leading-[82.263px] tracking-tighter text-gray-200">
                        Generate Reports that Speak  <br /> Volumes! with Dunlin AI
                    </p>
                    <div className=" text-start font-Bricolage-Grotesque lg:text-2xl text-xl font-normal text-white opacity-80 leading-normal md:leading-[38.561px] tracking-tighter md:tracking-normal py-6">Generate consolidated and customized reports instantly, communicating <br /> insights to stakeholders in a format they understand best.</div>
