        ...
        <div className="hero-container relative bg-white" >
            ...
            <div className="flex flex-col items-center justify-center min-h-screen" style={{ backgroundImage: "url('/ellipse.png')" }}>
                ...
                <div className="text-center space-y-6 my-10 px-4">
                    ...
                    <p className="my-10 text-start font-extrabold text-5xl md:text-7xl lg:text-7xl leading-[82.263px] tracking-tighter text-gray-200">
                        Copy-pasting and Formatting Isn't  <br /> Consolidation, It's a Workaround!
                    </p>
                    <div className=" text-start font-Bricolage-Grotesque lg:text-xl text-sm font-normal text-white opacity-80 leading-normal md:leading-[38.561px] tracking-tighter md:tracking-normal py-6">Import and link all your business and financial systems to Ganister's centralized and consolidated <br />platform. Obtain a comprehensive perspective on your organization's financial well-being, create custom  <br /> workflows, and access insights effortlessly.</div>
