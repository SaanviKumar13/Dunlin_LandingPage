const TermsOfUse = () => {
  return (
    <div
      ...
      className="bg-no-repeat bg-cover bg-[#042551] text-white py-16"
    >
      <div className="max-w-4xl mx-auto px-8 md:px-4 md:py-8">
        <h1 className="text-xl md:text-2xl text-center font-bold mb-6 md:mb-12">
          WEBSITE TERMS OF USE
          <br /> VERSION 1.0
          <br /> LAST REVISED ON: 8TH MAY 2024
        </h1>

        <p>
          The website located at https://dunlin.ai/ (the “<b>Site</b>”) is a
          copyrighted work belonging to SaaSDen, Inc. (“<b>Company</b>”, “
        ...
        <h2 className="text-lg font-semibold my-3 mb-4 mt-6">1. ACCOUNTS</h2>

        <div className="mb-6">
          <h3 className="text-lg font-semibold my-3">1.1 Account Creation</h3>
          <p>
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold my-3 mb-4 mt-6">
            2. ACCESS TO THE SITE
          </h2>

          <h3 className="text-lg font-semibold my-3">2.1 License</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold my-3">2.3 Modification</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold my-3">2.5 Ownership</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold my-3">2.6 Feedback</h3>
          <p>
        ...
        <div className="mb-6">
          ...
          <h3 className="text-lg font-semibold my-3">3.1 User Content</h3>
          <p>
            "User Content" means any and all information and content that a user
            submits to, or uses with, the Site (e.g., content in the user&apos;s
            ...
            or endorsed by Company. Since you alone are responsible for your
          ...
          <h3 className="text-lg font-semibold my-3">3.2 License</h3>
          <p>
          ...
          <p>
            ...
            <br />
            <br />
            <b>(a)</b> You agree not to use the Site to collect, upload,
            ...
            distribute to or through the Site any computer viruses, worms, or
            ...
            any other user&apos;s use and enjoyment of the Site; or (vii) use
            software or automated agents or scripts to produce multiple accounts
            on the Site, or to generate automated searches, requests, or queries
            to (or to strip, scrape, or mine data from) the Site (provided,
          ...
          <h3 className="text-lg font-semibold my-3">3.4 Enforcement</h3>
          <p>
            ...
            other person. Such action may include removing or modifying your
            User Content, terminating your Account in accordance with Section 8,
        ...
        <div className="mb-6">
          ...
          <p>
            ...
            data gathering practices. You should make whatever investigation you
            feel necessary or appropriate before proceeding with any transaction
            in connection with such Third-Party Links & Ads.
          </p>

          <h3 className="text-lg font-semibold my-3">5.2 Other Users</h3>
          <p>
          ...
          <h3 className="text-lg font-semibold my-3">5.3 Release</h3>
          <p>
        ...
        <div className="mb-6">
          ...
          <p>
            ...
            IN DURATION TO 90 DAYS FROM THE DATE OF FIRST USE.
            <br />
            <br />
          ...
          <h2 className="text-lg font-semibold my-3 mb-4">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold my-3 mb-4 mt-6">10. GENERAL</h2>

          <h3 className="font-semibold my-3 mb-4">10.1 Changes</h3>
          <p>
            ...
            notice of such changes shall indicate your acknowledgment of such
            changes and agreement to be bound by the terms and conditions of
            such changes.
          </p>

          <h3 className="font-semibold my-3 mb-4">10.2 Dispute Resolution</h3>
          <p>
            ...
            <br />
            <br />
            <b>(a) Applicability of Arbitration Agreement.</b> You agree that
            any dispute between you and any of the Company Parties relating in
            any way to the Site, the services offered on the Site (the
            “Services”) or these Terms will be resolved by binding arbitration,
            ...
            accordance with the preamble) or any prior version of these Terms.
            ...
            <br />
            <br />
            <b>(b) Informal Dispute Resolution.</b> There might be instances
            when a Dispute arises between you and Company. If that occurs,
            Company is committed to working with you to reach a reasonable
            resolution. You and Company agree that good faith informal efforts
            to resolve Disputes can result in a prompt, low‐cost and mutually
            beneficial outcome. You and Company therefore agree that before
            ...
            personally meet and confer telephonically or via videoconference, in
            a good faith effort to resolve informally any Dispute covered by
            this Arbitration Agreement (“Informal Dispute Resolution
            ...
            email to: aryaman@saasden.club, or by regular mail to 1111b South
            Governors Avenue, Dover, Delaware 19904. The Notice must include:
            ...
            <br />
            <br /> The Informal Dispute Resolution Conference shall be
            individualized such that a separate conference must be held each
            time either party initiates a Dispute, even if the same law firm or
            group of law firms represents multiple users in similar cases,
            ...
            from engaging in informal communications to resolve the initiating
            ...
            fulfilled before commencing arbitration. The statute of limitations
            and any filing fee deadlines shall be tolled while the parties
            engage in the Informal Dispute Resolution Conference process
            required by this section.
            <br />
            <br />
            <b>(c) Arbitration Rules and Forum.</b> These Terms evidence a
            ...
            an inquiry reasonable under the circumstances, that: (1) the Request
            ...
            Arbitration process discussed in Subsection 10.2(h) is triggered,
            ...
            will be solely as set forth in the applicable JAMS Rules. <br />
            <br />
            ...
            <br />
            <br />
            <b>(d) Authority of Arbitrator.</b> The arbitrator shall have
            ...
            <br />
            <br />
            <b>(e) Waiver of Jury Trial.</b> EXCEPT AS SPECIFIED IN SECTION
            10.2(A) YOU AND THE COMPANY PARTIES HEREBY WAIVE ANY CONSTITUTIONAL
            AND STATUTORY RIGHTS TO SUE IN COURT AND HAVE A TRIAL IN FRONT OF A
            JUDGE OR A JURY. You and the Company Parties are instead electing
            that all covered claims and disputes shall be resolved exclusively
            by arbitration under this Arbitration Agreement, except as specified
            in Section 10.2(a) above. An arbitrator can award on an individual
            ...
            <br />
            <br />
            <b>(f) Waiver of Class or Other Non-Individualized Relief.</b> YOU
            AND COMPANY AGREE THAT, EXCEPT AS SPECIFIED IN SUBSECTION 10.2(H)
            ...
            THE PARTIES HEREBY WAIVE ALL RIGHTS TO HAVE ANY DISPUTE BE BROUGHT,
            ...
            relief) shall be severed from the arbitration and may be litigated
            in the state or federal courts located in the State of Delaware. All
            other Disputes shall be arbitrated or litigated in small claims
            court. This subsection does not prevent you or Company from
            participating in a class-wide settlement of claims.
            <br />
            <br />
            <b>(g) Attorneys’ Fees and Costs. </b>The parties shall bear their
            own attorneys’ fees and costs in arbitration unless the arbitrator
            finds that either the substance of the Dispute or the relief sought
            in the Request was frivolous or was brought for an improper purpose
            ...
            <br />
            <br />
            <b>(h) Batch Arbitration.</b> To increase the efficiency of
            administration and resolution of arbitrations, you and Company agree
            that in the event that there are 100 or more individual Requests of
            a substantially similar nature filed against Company by or with the
            ...
            Arbitration”).
            <br />
            <br /> All parties agree that Requests are of a “substantially
            ...
            party shall advise the JAMS, and the JAMS shall appoint a sole
            standing arbitrator to determine the applicability of the Batch
            Arbitration process (“Administrative Arbitrator”). In an effort to
            ...
            Company.
            <br />
            <br /> You and Company agree to cooperate in good faith with the
            ...
            discovery disputes; and (2) the adoption of an expedited calendar of
            the arbitration proceedings.
            <br />
            <br /> This Batch Arbitration provision shall in no way be
            ...
            <br />
            <br />
            <b>(i) 30-Day Right to Opt Out.</b> You have the right to opt out of
            the provisions of this Arbitration Agreement by sending a timely
            written notice of your decision to opt out to the following address:
            1111b South Governors Avenue, Dover, Delaware 19904, or email to
            aryaman@saasden.club, within 30 days after first becoming subject to
            ...
            <br />
            <br />
            <b>(j) Invalidity, Expiration.</b> Except as provided in the
            subsection entitled “Waiver of Class or Other Non-Individualized
            ...
            Dispute that you have with Company as detailed in this Arbitration
            ...
            <br />
            <br />
            <b>(k) Modification.</b> Notwithstanding any provision in these
            Terms to the contrary, we agree that if Company makes any future
            ...
            Company at the following address: 1111b South Governors Avenue,
            Dover, Delaware 19904, or email to aryaman@saasden.club. Unless you
            reject the change within 30 days of such change becoming effective
            by writing to Company in accordance with the foregoing, your
            continued use of the Site and/or Services, including the acceptance
            of products and services offered on the Site following the posting
            of changes to this Arbitration Agreement constitutes your acceptance
            of any such changes. Changes to this Arbitration Agreement do not
            provide you with a new opportunity to opt out of the Arbitration
            Agreement if you have previously agreed to a version of these Terms
            and did not validly opt out of arbitration. If you reject any change
            or update to this Arbitration Agreement, and you were bound by an
            existing agreement to arbitrate Disputes arising out of or relating
            in any way to your access to or use of the Services or of the Site,
            any communications you receive, any products sold or distributed
            ...
            Terms (or accepted any subsequent changes to these Terms) remain in
            full force and effect. Company will continue to honor any valid opt
            outs of the Arbitration Agreement that you made to a prior version
            of these Terms.
          </p>

          <h3 className="font-semibold my-3 mb-4">10.3 Export</h3>
          <p>
          ...
          <h3 className="font-semibold my-3 mb-4">10.4 Disclosures</h3>
          <p>
          ...
          <h3 className="font-semibold my-3 mb-4">
          ...
          <h3 className="font-semibold my-3 mb-4">10.6 Entire Terms</h3>
          <p>
          ...
          <p>
            Copyright © 2024 SaaSDen, Inc. All rights reserved. All trademarks,
          ...
          <h3 className="font-semibold my-3 mb-4">10.8 Contact Information</h3>
          <p>
            Aryaman Singh <br />
            Address: 1111b South Governors Avenue, Dover, Delaware 19904 <br />
            Telephone: 9625951505 <br />
            Email: aryaman@saasden.club
          </p>
        </div>
      </div>
    </div>
